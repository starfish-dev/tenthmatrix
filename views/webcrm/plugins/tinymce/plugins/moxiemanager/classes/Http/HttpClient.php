...
class MOXMAN_Http_HttpClientRequest {
	/** @ignore */
	private $client, $url, $method, $headers, $basicAuthUser, $basicAuthPassword, $localFilePath, $curlContentLength, $isLastCurlResponse;
	...
	private function fputs($data, $isBody = false) {
		...
		fwrite($this->client->getOutputStream(), $data);
		$this->checkWriteTimeout();
	}
