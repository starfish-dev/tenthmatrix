<?php
	// General
	$moxieManagerConfig['general.license'] = 'TPJB-BBFY-GZJX-MJSW-OGSN-ZALO-H5YX-QEYG';
	...
	$moxieManagerConfig['filesystem.rootpath'] = '/home/tenthmatrixco/public_html';
	...
	$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,docx,doc,zip,pdf,mov,wav';
	...
	// IpAuthenticator
	$moxieManagerConfig['IpAuthenticator.ip_numbers'] = '';
	...
	// Local filesystem
	$moxieManagerConfig['filesystem.local.wwwroot'] = '/home/tenthmatrixco/public_html';
	...
	$moxieManagerConfig['log.path'] = '/home/tenthmatrixco/public_html/logs';
	...
	$moxieManagerConfig['storage.path'] = '/home/tenthmatrixco/public_html/storage';
